<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
    <ul style="list-style: none">
        ...
        <li style="text-align: center">
            <a href="{{URL::to('guia/romel')}}" class="menuGuias {{ $selected == 'romel' ? 'menuGuiasSelected' : '' }}">
        ...
        <li style="text-align: center">
            <a href="{{URL::to('guia/nicolas')}}" class="menuGuias {{ $selected == 'nicolas' ? 'menuGuiasSelected' : '' }}">
        ...
        <li style="text-align: center">
            <a href="{{URL::to('guia/robinsson')}}" class="menuGuias {{ $selected == 'robinsson' ? 'menuGuiasSelected' : '' }}">
        ...
        <li style="text-align: center">
            <a href="{{URL::to('guia/fabricio')}}" class="menuGuias {{ $selected == 'fabricio' ? 'menuGuiasSelected' : '' }}">
        ...
        <li style="text-align: center">
            <a href="{{URL::to('guia/ignacio')}}" class="menuGuias {{ $selected == 'ignacio' ? 'menuGuiasSelected' : '' }}">
