...
<div class="row page-content">
    ...
    <div class="col-xs-10 col-sm-6 col-md-6 col-lg-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1" style="text-align: justify">
        <h1>
            {{ getFrase("porqueVisistar",session("lang"), "Por qué visitar Ecuador?") }}
        </h1>
        <p>Ecuador un país pluricultural y plurinacional, catalogado como uno de los países
            ...
            se evidencia en sus cuatro regiones naturales:</p>
        <p>
            <span class="rojo">{{ getFrase("sierraORegion",session("lang"), "Sierra o región andina:") }}</span>
            Atravesada por la cordillera de los andes de norte a
        ...
        <p>
            <span class="rojo">{{ getFrase("costa",session("lang"), "Costa:") }}</span>
            Bañada por el Océano Pacífico con un clima cálido, donde se destacan
        ...
        <p>
            <span class="rojo">{{ getFrase("amazonia",session("lang"), "Amazonía:") }}</span>
            Quizás la región más diversa del país, no solamente en el aspecto
        ...
        <p>
            <span class="rojo">{{ getFrase("galapagos",session("lang"), "Galápagos:") }}</span>
            A 1000 Km del continente se encuentran este grupo de islas de
