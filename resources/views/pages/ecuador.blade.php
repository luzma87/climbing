...
@section('content')
    ...
    <div class="row page-content">
        ...
        <div class="col-xs-10 col-sm-6 col-md-6 col-lg-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1" style="text-align: justify">
            ...
            <p>
                {{ getFrase("porqueVisistarTexto",session("lang"), "Ecuador un país pluricultural y plurinacional, catalogado como uno de los países
            ...
            <p>
                ...
                {{ getFrase("galapagos",session("lang"), "A 1000 Km del continente se encuentran este grupo de islas de
