...
@section('content')
    ...
    <div class="row page-content">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " style="text-align: justify">
            ...
            <h1>
                {!! getFrase("terminosEquipo_condiciones",session("lang"), "TÉRMINOS Y CONDICIONES") !!}
            </h1>

            <h1>
                {!! getFrase("terminosEquipo_equipo",session("lang"), "Equipo") !!}
            </h1>

            <p>
                {!! getFrase("terminosEquipo_texto",session("lang"), "17 Se le proporcionará con una lista de todos los equipos necesarios para llevar a su
