...
<div class="row page-content">
    ...
    <div class="col-lg-2   col-md-2 col-sm-2  col-xs-2 text-left flechas-slider next " >
    ...
    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 " style="margin-top: 10px">
        <div class="row">
            ...
            <div class="small-slider sl-2 col-xs-12 col-sm-3 col-md-3 col-lg-3 pull-left"  index="2">
                <img src="{!!  URL::asset('assets/images/home/small2.PNG')  !!}"  style="width: 100%">
            </div>
            <div class="small-slider sl-3 col-xs-12  col-sm-3 col-md-3 col-lg-3 pull-left"  index="3">
                <img src="{!!  URL::asset('assets/images/home/small3.PNG')  !!}"  style="width: 100%">
            </div>
            <div class="small-slider sl-4 col-xs-12  col-sm-3 col-md-3 col-lg-3 pull-left"  index="4">
