...
Route::get('recomendaciones', 'RecomendacionesController@index');
Route::get('reserva', 'RecomendacionesController@reserva');
Route::get('entrega', 'RecomendacionesController@entrega');
Route::get('responsabilidad', 'RecomendacionesController@responsabilidad');
Route::get('equipoRecomendaciones', 'RecomendacionesController@equipoRecomendaciones');
Route::get('quejas', 'RecomendacionesController@quejas');
Route::get('general', 'RecomendacionesController@general');
